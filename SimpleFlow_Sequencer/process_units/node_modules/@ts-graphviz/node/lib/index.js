...
var tsGraphviz = require('ts-graphviz');
...
function renderDot(dot, _a) {
    ...
    var input = typeof dot === 'string' ? dot : tsGraphviz.toDot(dot);
...
function executeDot(dot, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0: return [4 /*yield*/, tmpPromise.file()];
                case 1:
...
function exportToBuffer(dot, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    input = typeof dot === 'string' ? dot : tsGraphviz.toDot(dot);
